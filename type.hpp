...
typedef std::shared_ptr<ReferenceAST> ReferenceASTPtr;
...
typedef std::shared_ptr<PointerTypeAST> PointerTypeASTPtr;
...
typedef std::shared_ptr<ExprTypeAST>		ExprTypeASTPtr;
...
typedef std::shared_ptr<NamedExprAST> NamedExprASTPtr;
#if 0
...
typedef std::shared_ptr<AssignmentExprAST> AssignmentExprASTPtr;
...
typedef std::shared_ptr<ExprListAST> ExprListASTPtr;
...
typedef std::shared_ptr<CallExprAST>	CallExprASTPtr;
